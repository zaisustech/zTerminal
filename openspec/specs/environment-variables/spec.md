...
Let users define environment variables in the application's Settings and have them injected
into the shells spawned for new terminal tabs, with validation, safe embedding, override of
inherited values, and shadowing warnings.
